...
>
> All of this comes from **one** setting: run `Tools/setup-xcode.sh <TEAMID>`. It writes the git-ignored
> `Config/Local.xcconfig` with your `DEVELOPMENT_TEAM` and `NOOP_BUNDLE_PREFIX = com.<TEAMID>.noopapp`,
